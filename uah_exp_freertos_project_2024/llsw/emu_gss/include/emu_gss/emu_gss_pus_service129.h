...
//SIMULATION CLASS CREATION FOR TC(129,1)
class EmuGSS_TCProgram129_1:public EmuGSS_TCProgram
{
	 ...
	 public:
	 EmuGSS_TCProgram129_1(uint32_t uniTime2YK, const char*brief, float sCVx, float sCVy);
};


//SIMULATION CLASS CREATION FOR TC(129,2)
class EmuGSS_TCProgram129_2:public EmuGSS_TCProgram
{
	 ...
	 virtual void BuildTCAppData(tc_descriptor_t &tc_descriptor);
     public:
	 EmuGSS_TCProgram129_2(uint32_t uniTime2YK, const char*brief, float sKpx, float sKpy);
};
